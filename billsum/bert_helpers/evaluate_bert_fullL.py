...
predictions = pd.read_csv(os.path.join(bert_score_dir,f"test_results.tsv"), sep='\t', header=None)
...
predictions = pd.read_csv(os.path.join(bert_score_dir,f"ca_test_results.tsv"), sep='\t', header=None)
pos_pred = predictions[1].values
