...
def load_billsum_pickles(pattern, rouge_threshold=0.1):
    ...
    print(f"Processing {pattern} using ROUGE-l for Oracle labels...")
...
save_results_aligned(tokenized_test, "test_results_full2_fast.tsv")

# Note: The original script uses 'ca_test_results.tsv'
save_results_aligned(tokenized_ca, "ca_test_results_full2_fast.tsv")
